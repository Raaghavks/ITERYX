            ...
            {[
              {
                ...
                description:
                  "Overview of hospital KPIs, live occupancy charts, and emergency alerts.",
              ...
              },
              {
                ...
                title: "Doctor Queue",
                description:
                  "Prioritized patient queue with AI triage scoring and consult flow management.",
                icon: Stethoscope,
                shell: "bg-blue-50",
              ...
              },
              {
                ...
                description:
                  "Patient intake with vitals capture and automatic triage assignment.",
                icon: UserPlus,
                shell: "bg-teal-50",
              ...
              return (
                <Link
                  key={item.title}
                  href={item.href}
                  className="group rounded-[32px] border border-slate-100 bg-slate-50 p-2 transition-all duration-500 hover:border-indigo-200"
                >
                  <div className="space-y-6 rounded-[24px] border border-slate-100 bg-white p-8 shadow-sm transition-all group-hover:shadow-xl">
                    <div
                      className={`flex h-16 w-16 items-center justify-center rounded-2xl ${item.shell} transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
                    >
                    ...
                    <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-slate-400 transition-colors group-hover:text-indigo-600">
